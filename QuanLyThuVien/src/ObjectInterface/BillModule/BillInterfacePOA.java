 ...
 implements ObjectInterface.BillModule.BillInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_readerName", new java.lang.Integer (10));
    _methods.put ("_set_readerName", new java.lang.Integer (11));
    _methods.put ("_get_bookName", new java.lang.Integer (12));
    _methods.put ("_set_bookName", new java.lang.Integer (13));
    _methods.put ("getSingle", new java.lang.Integer (14));
    _methods.put ("list", new java.lang.Integer (15));
    _methods.put ("borrowBook", new java.lang.Integer (16));
    _methods.put ("payBook", new java.lang.Integer (17));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 10:  // ObjectInterface/BillModule/BillInterface/_get_readerName
       {
         String $result = null;
       ...
       case 11:  // ObjectInterface/BillModule/BillInterface/_set_readerName
       {
       ...
       case 12:  // ObjectInterface/BillModule/BillInterface/_get_bookName
       {
         String $result = null;
       ...
       case 13:  // ObjectInterface/BillModule/BillInterface/_set_bookName
       {
       ...
       case 14:  // ObjectInterface/BillModule/BillInterface/getSingle
       {
         int id = in.read_long ();
       ...
       case 15:  // ObjectInterface/BillModule/BillInterface/list
       {
       ...
       case 16:  // ObjectInterface/BillModule/BillInterface/borrowBook
       {
         int readerID = in.read_long ();
       ...
       case 17:  // ObjectInterface/BillModule/BillInterface/payBook
       {
         int ids[] = ObjectInterface.BillModule.longsHelper.read (in);
         int billID = in.read_long ();
         boolean $result = false;
         $result = this.payBook (ids, billID);
         out = $rh.createReply();
