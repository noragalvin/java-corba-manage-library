...
/**
* ObjectInterface/UserModule/UserHelper.java .
...
{
  private static String  _id = "IDL:ObjectInterface/UserModule/User:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[4] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (ObjectInterface.UserModule.UserHelper.id (), "User", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    ObjectInterface.UserModule.User value = new ObjectInterface.UserModule.User ();
