...
public class _UserInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements ObjectInterface.UserModule.UserInterface
{
  ...
  public ObjectInterface.UserModule.User getSingle (int id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public ObjectInterface.UserModule.User[] list ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("list", true);
                $in = _invoke ($out);
                ObjectInterface.UserModule.User $result[] = ObjectInterface.UserModule.UsersHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public int add (ObjectInterface.UserModule.User u)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("add", true);
                ObjectInterface.UserModule.UserHelper.write ($out, u);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public int delete (ObjectInterface.UserModule.User u)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public int update (ObjectInterface.UserModule.User u)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
