...
/**
* ObjectInterface/BookModule/NXBHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Module/Book.idl
* Thursday, November 7, 2019 10:59:29 PM ICT
*/

abstract public class NXBHelper
{
  private static String  _id = "IDL:ObjectInterface/BookModule/NXB:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (ObjectInterface.BookModule.NXBHelper.id (), "NXB", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    ObjectInterface.BookModule.NXB value = new ObjectInterface.BookModule.NXB ();
